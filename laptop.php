...
// $stmt = $db->prepare("SELECT ItemID, Name, Price, Image FROM items");
$categorie = 'laptop';
...
<div class="container mt-3">
    <h1 class="text-center text-uppercase fw-900">Laptops</h1>
    <div class="articles">
        <div class="row">
            <?php if (empty($rows)) { ?>
            ...
            <?php foreach ($rows as $row) { ?>
                <form class="article_box text-center col-lg-4 col-md-4 col-sm-6"
                    ...
                    <div class="article_text">
                        ...
                        <div class="d-flex align-items-center justify-content-center cart__div">
